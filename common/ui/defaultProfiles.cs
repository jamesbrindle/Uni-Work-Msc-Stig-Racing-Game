...
//Added for timer display while in game
if(!isObject(GuiTimerTextProfile)) new GuiControlProfile (GuiTimerTextProfile : GuiTextProfile)
{
    fontColor = "255 255 255";
    fontSize = 24;
};

//Added for best time display while in game
if(!isObject(GuiBestTimerTextProfile)) new GuiControlProfile (GuiBestTimerTextProfile : GuiTextProfile)
{
    fontColor = "0 255 0";
    fontSize = 18;
};
